...
In order to use Proto.OpenTelemetry with Proto.Actor first you need to create Proto.Actor and call extension method `WithTracing()`.
...
var props = Props
    ...
    //this extension enables OpenTelemetry
    .WithTracing();
```
